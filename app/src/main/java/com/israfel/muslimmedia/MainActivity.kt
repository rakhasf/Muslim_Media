...
import com.israfel.muslimmedia.adapter.SectionPagerAdapter
import com.israfel.muslimmedia.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // array for set little tab item in layout
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        val searchView =
            menu?.findItem(R.id.option_search)?.actionView as SearchView
